...
- Neural network architecture basics (forward pass, backpropagation)
- Model training workflows and optimization
- Loss metrics and performance evaluation
...
- Python scripts for model setup and evaluation
- Visualizations of training behavior (loss / accuracy over epochs)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/varungupta04/DeepLearning-Training-Workbench.git
